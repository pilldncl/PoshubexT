// OAuth Configuration Template for TrackHub Chrome Extension
// 
// ⚠️  SECURITY WARNING: This is a template file!
// 
// 1. Copy this file to 'oauth-credentials.js'
// 2. Replace the placeholder values with your actual credentials
// 3. NEVER commit 'oauth-credentials.js' to Git
// 4. The 'oauth-credentials.js' file is already in .gitignore
...
export const OAUTH_CONFIG = {
  google: {
    ...
    // Replace with your actual Google Client Secret from Google Cloud Console
    // Format: 'GOCSPX-abcdefghijklmnopqrstuvwxyz'
    clientSecret: 'YOUR_GOOGLE_CLIENT_SECRET',
    
    // OAuth scopes (usually don't need to change these)
    scopes: ['openid', 'email', 'profile'],
    
    // Redirect URI (automatically handled by Chrome extension)
